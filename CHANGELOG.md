...
- Updated project documentation to include relevant project specifics
  (build process, local development, etc.)
...
- Introduced **Summary** form section to the registration flow
